...
public class MoustachedTamarin extends Animal implements GeoEntity {

    public MoustachedTamarin(EntityType<? extends Animal> p_i48568_1_, Level p_i48568_2_) {
    ...
    @Nullable
    @Override
    public MoustachedTamarin getBreedOffspring(ServerLevel world, AgeableMob animal) {
