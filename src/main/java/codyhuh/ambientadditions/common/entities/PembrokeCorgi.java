...
public class PembrokeCorgi extends TamableAnimal implements GeoEntity {
   private static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(PembrokeCorgi.class, EntityDataSerializers.INT);
   ...
   public PembrokeCorgi getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
      PembrokeCorgi corgi = AAEntities.PEMBROKE_CORGI.get().create(p_241840_1_);
